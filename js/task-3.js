...
const galleryListContainerRef = document.querySelector('#gallery');
console.log(galleryListContainerRef);
...
galleryListContainerRef.insertAdjacentHTML('afterbegin', galleryList.join(''));
